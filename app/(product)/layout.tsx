...
import { Blocks, Database, FileCheck2, LayoutDashboard, MessageSquare, Search, Settings, ShieldAlert, ShieldCheck } from "lucide-react";
...
const navigation = [
  ...
  { href: "/security", label: "Security intelligence", icon: ShieldAlert },
