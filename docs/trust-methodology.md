...
Version `2026.2` is the current executable specification.
...
Evidence confidence decays with a 365-day half-life from its observation time. Expired, rejected, pending, and superseded evidence does not contribute. Dimension confidence is the mean effective confidence of its evidence, and overall confidence is the dimension-confidence-weighted sum. Materially contradictory evidence is retained and called out rather than silently discarded.
