...
- `CI`: clean install, lint, strict typecheck, unit tests, PostgreSQL migrations, MCP bundle and protocol smoke test, production web build, Chromium onboarding and WCAG checks, production HTTP smoke tests, production dependency audit, and separate web/MCP OCI image builds.
